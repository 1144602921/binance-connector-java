...
public class MarketApiTest {
     ...
     */
    @Test
    public void compositeIndexSymbolInformationStreamsTest()
            throws ApiException, URISyntaxException, IOException {
        ...
        StreamBlockingQueueWrapper<CompositeIndexSymbolInformationStreamsResponse> response =
                api.compositeIndexSymbolInformationStreams(
                        compositeIndexSymbolInformationStreamsRequest);
        ArgumentCaptor<
                        RequestWrapperDTO<
                                Set<String>, CompositeIndexSymbolInformationStreamsResponse>>
                callArgumentCaptor = ArgumentCaptor.forClass(RequestWrapperDTO.class);
        Mockito.verify(connectionSpy).innerSend(callArgumentCaptor.capture());
        ArgumentCaptor<String> sendArgumentCaptor = ArgumentCaptor.forClass(String.class);
        Mockito.verify(sessionMock).sendText(sendArgumentCaptor.capture(), Mockito.any());
        ...
        URL resource =
                MarketApiTest.class.getResource(
                        "/expected/stream/WebsocketMarketStreamsApi/symbol@compositeIndex-test.json");
        String expectedJson = Files.readString(Paths.get(resource.toURI()));
        JSONAssert.assertEquals(expectedJson, sentPayload, true);
    }
    ...
    public void continuousContractKlineCandlestickStreamsTest()
        ...
        URL resource =
                MarketApiTest.class.getResource(
                        "/expected/stream/WebsocketMarketStreamsApi/pair_contractType@continuousKline_interval-test.json");
        String expectedJson = Files.readString(Paths.get(resource.toURI()));
        JSONAssert.assertEquals(expectedJson, sentPayload, true);
    }
    ...
    public void markPriceStreamTest() throws ApiException, URISyntaxException, IOException {
        ...
        URL resource =
                MarketApiTest.class.getResource(
                        "/expected/stream/WebsocketMarketStreamsApi/symbol@markPriceupdateSpeed-test.json");
        String expectedJson = Files.readString(Paths.get(resource.toURI()));
        JSONAssert.assertEquals(expectedJson, sentPayload, true);
    }
     ...
     */
    @Test
    public void markPriceStreamForAllMarketTest()
            throws ApiException, URISyntaxException, IOException {
        ...
        StreamBlockingQueueWrapper<MarkPriceStreamForAllMarketResponse> response =
                api.markPriceStreamForAllMarket(markPriceStreamForAllMarketRequest);
        ArgumentCaptor<RequestWrapperDTO<Set<String>, MarkPriceStreamForAllMarketResponse>>
                callArgumentCaptor = ArgumentCaptor.forClass(RequestWrapperDTO.class);
        Mockito.verify(connectionSpy).innerSend(callArgumentCaptor.capture());
        ArgumentCaptor<String> sendArgumentCaptor = ArgumentCaptor.forClass(String.class);
        Mockito.verify(sessionMock).sendText(sendArgumentCaptor.capture(), Mockito.any());
